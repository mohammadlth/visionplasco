                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="input-group">
                        ...
                        <select name="sex" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('sex') && old('sex') == 1 ? ' selected ' : ''  }}  value="1">
                                مرد
                            </option>
                            <option {{old('sex') && old('sex') == 0 ? ' selected ' : ''  }}  value="0">
                                زن
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="account" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('account') && old('account') == 'buyer' ? ' selected ' : ''  }}  value="buyer">
                                خریدار
                            </option>
                            <option {{old('account') && old('account') == 'seller' ? ' selected ' : ''  }}  value="seller">
                                فروشنده
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="ban" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('ban') && old('ban') == 0 ? ' selected ' : ''  }}  value="0">
                                باز
                            </option>
                            <option {{old('ban') && old('ban') == 1 ? ' selected ' : ''  }}  value="1">
                                قفل
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="is_admin" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('is_admin') && old('is_admin') == 0 ? ' selected ' : ''  }}  value="0">
                                کاربر عادی
                            </option>
                            <option {{old('is_admin') && old('is_admin') == 1 ? ' selected ' : ''  }}  value="1">
                                ادمین
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="confirm_identity" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('confirm_identity') && old('confirm_identity') == 0 ? ' selected ' :  ''  }}  value="0">
                                تایید نشده
                            </option>
                            <option {{old('confirm_identity') && old('confirm_identity') == 1 ? ' selected ' :  ''  }}  value="1">
                                تکمیل شده - تایید
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="vip_account" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('vip_account') && old('vip_account') == 0 ? ' selected ' : ''  }}  value="0">
                                کاربر عادی
                            </option>
                            <option {{old('vip_account') && old('vip_account') == 1 ? ' selected ' : ''  }}  value="1">
                                کاربر ویژه
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="expired" class="border rounded-sm px-2 py-1 bg-gray-100">
                            <option {{old('expired') && old('expired') == 1 ? ' selected ' : ''  }}  value="1">
                                اکسپایر شده
                            </option>
                            <option {{old('expired') && old('expired') == 0 ? ' selected ' : ''  }}  value="0">
                                اکسپایر نشده
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" disabled class="border rounded-sm px-2 py-1 bg-gray-100"
                               value="" placeholder="آخرین فعالیت">
                    </div>
