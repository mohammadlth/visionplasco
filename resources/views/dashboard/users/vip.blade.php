...
@section('body')
    <section class="card col-span-2 xl:col-span-1 p-3">
        ...
        <table class="table-auto w-full text-right">
            <thead>
            <tr class="border-t">
                <th class="px-4 py-2 border-r">لیست کاربران ویژه</th>
            ...
            <tr>
                ...
                <th class="px-4 py-2 border-t">تاریخ اکسپایر</th>
            ...
            @if(count($users) > 0)
                @foreach($users as $value)
                    <tr>
                        ...
                        <td class="border border-l-0 px-4 py-2">
                            @if(!is_null($value->vip_expire_at))
                                {{Verta($value->vip_expire_at)->formatDifference()}}
                            @else
                                ------
                            @endif
                        </td>
